    ...
    return (
        <div className="form-page">
            ...
            <div className="profile-card">
                ...
                <div className="settings-list">
                    <div className="settings-item" style={{ color: '#a32d2d' }}>
...
function Help({ onBack }) {
    const faqs = [
        ...
        { q: 'Is Chamba free for workers?', a: 'Yes — Chamba is completely free for workers. Contractors pay the subscription.' },
